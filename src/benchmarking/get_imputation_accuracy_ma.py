...
def calculate_accuracy(gt_vcf_location, target_vcf_location, imputed_vcf_location):
    ...
    target_vcf = target_vcf[target_vcf['ALT'].str.contains(',')]
    target_vcf = target_vcf[target_vcf.columns[9:]]
    gt_vcf = gt_vcf[gt_vcf.columns[9:]][gt_vcf.index.isin(target_vcf.index)]
    imputed_vcf = imputed_vcf[imputed_vcf.columns[9:]][imputed_vcf.index.isin(target_vcf.index)]
